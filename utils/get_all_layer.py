...
def get_all_layers_tiles_data(db_name=Database.PG_RECORD_PYCSW_DB):
...
def get_layer_list_tile_data(layer_list, db_name=Database.PG_RECORD_PYCSW_DB):
    """
...
def create_layer_tiles_urls(layer_name, tiles_list: List[tuple]):
    ...
    for tile_value in tiles_list:
        url = (
            ...
            f"/{tile_value[1]}/"
            f"{tile_value[2]}{config_obj['wmts'].IMAGE_FORMAT}"
