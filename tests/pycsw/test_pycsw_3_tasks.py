...
polygon = {
    "name": config_obj["pycsw"].PYCSW_POLYGON_PROPERTY,
    "value": config_obj["pycsw"].PYCSW_POLYGON_VALUE,
}
by_id = {
    "name": config_obj["pycsw"].PYCSW_ID_PROPERTY,
    "value": config_obj["pycsw"].PYCSW_ID_VALUE,
}
by_region = {
    "name": config_obj["pycsw"].PYCSW_REGION_PROPERTY,
    "value": config_obj["pycsw"].PYCSW_REGION_VALUE,
}
