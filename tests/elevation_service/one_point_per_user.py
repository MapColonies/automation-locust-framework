...
from common.validation.validation_utils import (
    write_rps_percent_results, get_request_parameters, extract_points_from_json,
)
...
class CustomUser(HttpUser):
    ...
    def on_start(self):
        index = self.environment.runner.user_count - 1
        self.body = self.request_bodies[index % len(self.request_bodies)]
    ...
    def index(self):
        ...
        self.client.post(
            "/", json=self.body, headers={'Content-Type': 'application/json'}
        )
